...
export default function SubmitListing() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    fetch("/api/v1/businesses", {
      ...
      .then((res) => res.json())
      .then((data) => fetch("/api/v1/listings/submit", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  return (
    <div className="win95-submit">
      ...
      <form className="win95-form" onSubmit={handleSubmit}>
        <fieldset hidden={currentStep !== 1}><legend>Business details</legend>
        ...
        <fieldset hidden={currentStep !== 2}><legend>Location and contact</legend>
        ...
        <fieldset hidden={currentStep !== 3}><legend>SEO and plan</legend>
